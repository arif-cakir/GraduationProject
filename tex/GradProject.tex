...
\textbf{Figure 2:} GloVe vectors capturing relation between city and zip code, from Stanford\\[2\baselineskip]

\end{center}


Furthermore, the GloVe method's computational time is reduced by a rather simpler least square error function. Also, GloVe handles out of vocabulary words better than Word2Vec. Due to that, GloVe performs better in word analogy and named entity recognition tasks. 
